...
public interface IUnitOfWork
{
    ...
    ILibrariannPlusAuditRepository LibrariannPlusAuditRepository { get; }
    IIntegrationProviderRepository IntegrationProviderRepository { get; }
    IAcquisitionDownloadRepository AcquisitionDownloadRepository { get; }
    IMetadataFieldProvenanceRepository MetadataFieldProvenanceRepository { get; }
    IQualityProfileRepository QualityProfileRepository { get; }
