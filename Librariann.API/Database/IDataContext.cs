...
namespace Librariann.API.Database;
...
public interface IDataContext : IDisposable
{
    ...
    DbSet<LibrariannPlusAuditLog> LibrariannPlusAuditLogs { get; }
    DbSet<IntegrationProviderConfiguration> IntegrationProviderConfigurations { get; }
    DbSet<AcquisitionDownload> AcquisitionDownloads { get; }
    DbSet<MetadataFieldProvenance> MetadataFieldProvenances { get; }
    DbSet<QualityProfile> QualityProfiles { get; }
    DbSet<MonitoringTarget> MonitoringTargets { get; }
    DbSet<MonitoringSearchRun> MonitoringSearchRuns { get; }
    DbSet<WantedItem> WantedItems { get; }
    DbSet<AppUserFollowedPerson> AppUserFollowedPeople { get; }
