...
public interface IAccountService
{
    ...
    /// <param name="ct"></param>
    /// <returns>If true, user should not be updated by librariann (anymore)</returns>
    /// <exception cref="LibrariannException">Throws if invalid actions are being performed</exception>
