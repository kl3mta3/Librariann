...
public interface IExternalMetadataService
{
    ...
    /// <summary>
    /// This is a task that runs on a schedule and slowly fetches data from Librariann+ to keep
    /// data in the DB non-stale and fetched.
    /// </summary>
    /// <remarks>To avoid blasting Librariann+ API, this only processes 25 records. The goal is to slowly build out/refresh the data</remarks>
    /// <returns></returns>
    ...
    /// <summary>
    /// Given external metadata from Librariann+, write as much as possible to the Librariann series as possible
    /// </summary>
