...
public interface IBookService
{
    ...
    /// </summary>
    /// <remarks>This method relies on Docnet which has explicit patches from Librariann for ARM support. This should only be used with Tachiyomi</remarks>
    ...
    /// <param name="baseUrl">The API base for Librariann, to rewrite urls to so we load though our endpoint</param>
    /// <param name="ptocBookmarks"></param>
    /// <param name="annotations"></param>
    /// <param name="ct"></param>
    /// <returns>Full epub HTML Page, scoped to Librariann's reader</returns>
    /// <exception cref="LibrariannException">All exceptions throw this</exception>
