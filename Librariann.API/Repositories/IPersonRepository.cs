...
public interface IPersonRepository
{
    ...
    Task<Person?> GetPersonByOpenLibraryId(string openLibraryId, CancellationToken ct = default);
    ...
    Task<AppUserFollowedPerson?> GetFollowAsync(int userId, int personId, CancellationToken ct = default);
    Task<bool> IsFollowingAsync(int userId, int personId, CancellationToken ct = default);
    void Follow(AppUserFollowedPerson follow);
    void Unfollow(AppUserFollowedPerson follow);
}
