...
public interface IChapterRepository
{
    ...
    /// If LibrariannIds are passed, will prioritize over CV/Metron.
    /// </summary>
    Task<IList<Chapter>> GetChaptersByExternalIdsAsync(IList<int> librariannIds, IList<string> comicVineIds, IList<long> metronIds, IList<int> libraryIds, CancellationToken ct = default);
