...
public interface ISeriesRepository
{
    ...
    Task<PagedList<SeriesDto>> GetRecentlyAddedInFavoriteGenresAsync(int userId, UserParams userParams,
        CancellationToken ct = default);
    Task<PagedList<SeriesDto>> GetRecentlyDownloadedAsync(int userId, UserParams userParams,
        CancellationToken ct = default);
    Task<PagedList<MissingSeriesItemDto>> GetMissingFromMonitoredSeriesAsync(int userId, UserParams userParams,
        CancellationToken ct = default);
    Task<PagedList<SeriesDto>> GetBecauseYouReadAsync(int userId, UserParams userParams,
        CancellationToken ct = default);
    Task<PagedList<SeriesDto>> GetNewFromFollowedAuthorsAsync(int userId, UserParams userParams,
        CancellationToken ct = default);
    Task<PagedList<SeriesDto>> GetNextInSeriesAsync(int userId, UserParams userParams,
        CancellationToken ct = default);
    ...
    Task<SeriesDetailRequestV3Dto?> GetLibrariannPlusSeriesDetailRequestV3Dto(int seriesId, CancellationToken ct = default);
    /// <summary>
