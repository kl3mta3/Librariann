...
import {PendingInvitesNavIconComponent} from '../pending-invites-nav-icon/pending-invites-nav-icon.component';
...
@Component({
  ...
  imports: [RouterLink, RouterLinkActive, GroupedTypeaheadComponent, ImageComponent,
    ...
    TranslocoDirective, CollectionOwnerComponent, PromotedIconComponent, QuillViewComponent, ProfileIconComponent, DownloadQueueWidgetComponent,
    PendingInvitesNavIconComponent]
})
