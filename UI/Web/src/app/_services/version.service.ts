...
export class VersionService {
  ...
  public static readonly SERVER_VERSION_KEY = 'librariann--version';
  public static readonly CLIENT_REFRESH_KEY = 'librariann--client-refresh-last-shown';
  private static readonly DISMISS_KEY_PREFIX = 'librariann--update-dismiss-';
  ...
  /** After this many dismissals, Librariann will stop pestering the user */
