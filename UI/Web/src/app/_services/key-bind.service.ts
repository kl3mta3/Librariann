...
/**
 * This record should hold all KeyBinds Librariann has to offer, with their default combination(s).
...
export const KeyBindGroups: KeyBindGroup[] = [
  {
    ...
    elements: [
      ...
      {target: KeyBindTarget.NavigateToScrobbling, librariannPlus: true},
...
export class KeyBindService {
  ...
  /**
   * A record of all possible keybinds in Librariann, as configured by the user
   */
