...
import {ExternalCoverImageType, ExternalCoverResponse} from "../_models/librariannplus/external-cover-response";
...
export class ImageService {
  ...
  constructor() {
    this.themeService.isDarkMode$.pipe(takeUntilDestroyed(this.destroyRef)).subscribe(() => {
  ...
  getLibrariannPlusSeriesCoverImages(seriesId: number, volumeId: number | null = null, chapterId: number | null = null) {
