...
export interface CoverImageChooserConfig {
  ...
  librariannplusFunc?: Observable<CoverImageOption[]>;
...
export class CoverChooserConfigFactoryService {
  ...
  public forSeries(series: Series, volumes: Volume[], libraryType: LibraryType) {
    ...
    return {
      ...
      librariannplusFunc: this.licenseService.hasActiveLicense() ?
        this.imageService.getLibrariannPlusSeriesCoverImages(series.id) : undefined
      ,
    };
  }
  ...
  public forVolume(volume: Volume, libraryType: LibraryType): CoverImageChooserConfig {
    return {
      ...
      librariannplusFunc: this.licenseService.hasActiveLicense() ?
        this.imageService.getLibrariannPlusSeriesCoverImages(volume.seriesId, volume.id) : undefined
    };
  }
  ...
  public forChapter(chapter: Chapter, libraryType: LibraryType, seriesId: number): CoverImageChooserConfig {
    return {
      ...
      librariannplusFunc: this.licenseService.hasActiveLicense() ?
        this.imageService.getLibrariannPlusSeriesCoverImages(seriesId, null, chapter.id) : undefined
    };
  }
