...
import {LibrariannPlusScrobbleDetails} from "../_models/librariannplus/librariann-plus-scrobble-details";
...
export class EntityTitleService {
   ...
   */
  scrobbleDetailLabel(details: LibrariannPlusScrobbleDetails): string {
