...
import {LibrariannTitleStrategy} from "../../../_services/librariann-title.strategy";
...
export class ProfileComponent {
  ...
  private readonly librariannTitleStrategy = inject(LibrariannTitleStrategy);
  ...
  constructor() {
    ...
    effect(() => {
      ...
      if (info) {
        this.librariannTitleStrategy.setTranslatedTitle('title.profile', {username: info.username});
      }
    });
  }
