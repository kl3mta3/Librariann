...
import {RequestInviteModalComponent} from "../_modals/request-invite-modal/request-invite-modal.component";
...
export class UserLoginComponent implements OnInit {
  ...
  showRequestInvite = signal(false);
  ...
  ngOnInit(): void {
    ...
    this.accountService.isInviteRequestEnabled().subscribe(enabled => {
      this.showRequestInvite.set(enabled);
      this.cdRef.markForCheck();
    });
  ...
  openRequestInviteModal() {
    this.modalService.open(RequestInviteModalComponent);
  }
}
