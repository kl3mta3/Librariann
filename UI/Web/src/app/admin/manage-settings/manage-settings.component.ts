...
export class ManageSettingsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.settingsService.getServerSettings().subscribe((settings: ServerSettings) => {
      ...
      this.settingsForm.addControl('writeMetadataToFiles', new FormControl(this.serverSettings.writeMetadataToFiles, [Validators.required]));
  ...
  resetForm() {
    ...
    this.settingsForm.get('writeMetadataToFiles')?.setValue(this.serverSettings.writeMetadataToFiles, {onlySelf: true, emitEvent: false});
