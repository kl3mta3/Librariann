...
import {LibrariannPlusProviderHealthStatusPipe} from '../../../_pipes/librariann-plus-provider-health-status.pipe';
...
@Component({
  ...
  imports: [
    ...
    LibrariannPlusProviderHealthStatusPipe,
...
export class ScrobbleHealthComponent {
  ...
  private readonly _snapshots = signal<LibrariannPlusProviderHealthSnapshot[]>([]);
