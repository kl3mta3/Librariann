...
import {MetadataFieldChange} from "../../../_models/librariannplus/metadata-field-change";
import {MetadataFieldChangeKindTitlePipe} from "../../../_pipes/metadata-field-change-kind-title.pipe";
import {MetadataFieldChangeKind} from "../../../_models/librariannplus/metadata-field-change-kind.enum";
...
@Component({
  selector: 'app-librariannplus-diff',
  ...
  templateUrl: './librariannplus-diff.component.html',
  styleUrl: './librariannplus-diff.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class LibrariannplusDiffComponent {
