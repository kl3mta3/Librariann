...
export class ChangePasswordComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.passwordChangeForm.addControl('password', new FormControl('', [Validators.required, Validators.minLength(12), Validators.maxLength(256)]));
    this.passwordChangeForm.addControl('confirmPassword', new FormControl('', [Validators.required, Validators.minLength(12), Validators.maxLength(256)]));
