...
import {ReadStatusTransitionRule} from "../../_models/librariannplus/scrobble-providers/read-status-transition-rule";
import {
  ReviewScrobbleTarget,
  ReviewScrobbleTargets
} from "../../_models/librariannplus/scrobble-providers/review-scrobble-target.enum";
import {ScrobbleProviderSettings} from "../../_models/librariannplus/scrobble-providers/scrobble-provider-settings";
import {
  ScrobbleReadStatus,
  ScrobbleReadStatuses
} from "../../_models/librariannplus/scrobble-providers/scrobble-read-status.enum";
