...
import {ThemeProvider} from 'src/app/_models/preferences/theme-provider';
...
import {BookBambooTheme} from '../../_models/book-bamboo-theme';
...
export const bookColorThemes = [
  ...
  },
  {
    ...
    isDefault: false,
    provider: ThemeProvider.System,
    selector: 'brtheme-bamboo',
    content: BookBambooTheme,
    translationKey: 'theme-bamboo'
  },
  {
    name: 'Custom',
    colorHash: '#B77CFF',
