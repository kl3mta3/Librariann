...
using Librariann.Database.Interceptors;
...
{
    public static void AddLibrariannDatabases(this IServiceCollection services)
    {
        services.AddSqLite();
    ...
    private static void AddSqLite(this IServiceCollection services)
    {
        ...
        {
            options.UseSqlite("Data source=config/librariann.db", builder =>
            {
