...
public class AnnotationRepository(DataContext context) : IAnnotationRepository
{
    ...
    private async Task<IQueryable<AnnotationDto>> CreatedFilteredAnnotationQueryable(int userId, AnnotationFilterDto filter)
    {
        ...
        return limitedQuery.Select(AnnotationMapping.ToAnnotationDtoExpression);
    }
        ...
        CancellationToken ct = default)
    {
        ...
        return await context.AppUserAnnotation
            ...
            .RestrictBySocialPreferences(userId, userPreferences)
            .Select(AnnotationMapping.ToFullAnnotationDtoExpression)
            .OrderFullAnnotation()
            .ToListAsync(ct);
    }
