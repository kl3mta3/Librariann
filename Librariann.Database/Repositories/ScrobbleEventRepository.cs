...
/// </summary>
public class ScrobbleRepository(DataContext context) : IScrobbleRepository
{
    ...
    public async Task<IEnumerable<ScrobbleErrorDto>> GetScrobbleErrors(CancellationToken ct = default)
    {
        return await context.ScrobbleError
            ...
            .Select(ScrobbleErrorMapping.ToScrobbleErrorDtoExpression)
            .ToListAsync(ct);
    }
        ...
        UserParams pagination, CancellationToken ct = default)
    {
        var query =  context.ScrobbleEvent
            ...
            .AsSplitQuery()
            .Select(ScrobbleEventMapping.ToScrobbleEventDtoExpression);
