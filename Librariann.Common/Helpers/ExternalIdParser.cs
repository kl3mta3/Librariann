...
namespace Librariann.Common.Helpers;
#nullable enable
...
public static class ExternalIdParser
{
    ...
    /// <see cref="HardcoverSeriesWebsite"/>/<see cref="HardcoverBookWebsite"/> links Librariann generates itself.
    ...
    /// </summary>
    /// <remarks>Returns null for the numeric-id links Librariann generates itself, as those carry an id and not a slug</remarks>
    public static HardcoverUrlSlug? GetHardcoverSlugFromUrl(string? text)
    {
        ...
        // The legacy https://hardcover.app/series/id/{id} links Librariann used to generate would otherwise be read as
