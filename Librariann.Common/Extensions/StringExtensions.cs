...
public static partial class StringExtensions
{
    ...
    /// <summary>
    /// Normalize everything within Librariann. Some characters don't fall under Unicode, like full-width characters and need to be
    ...
    extension(string? value)
    {
        ...
        /// <summary>
        /// Returns true if this Librariann+ API error message indicates the series could not be matched ("Unknown Series").
        /// </summary>
