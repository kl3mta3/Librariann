...
using Librariann.Models.Entities.Enums.Font;
...
public static partial class Parser
{
    ...
    public const string AudioFileExtensions = @"\.m4b|\.mp3|\.m4a";
    ...
    public static string ParseSeries(string filename, LibraryType type)
    {
        return type switch
        {
            ...
            LibraryType.Audiobook => ParseMangaSeries(filename),
            _ => string.Empty
        };
    }
    ...
    public static string ParseVolume(string filename, LibraryType type)
    {
        return type switch
        {
            ...
            LibraryType.Audiobook => ParseMangaVolume(filename),
            _ => LooseLeafVolume
        };
    }
    ...
    public static string ParseChapter(string filename, LibraryType type)
    {
        return type switch
        {
            ...
            LibraryType.Audiobook => ParseMangaChapter(filename),
            _ => DefaultChapter
        };
    }
    ...
    private static readonly string[] AudioExtensionList = [".m4b", ".mp3", ".m4a"];

    public static bool IsAudio(string filePath)
    {
        var ext = Path.GetExtension(filePath);
        return AudioExtensionList.Any(a => ext.Equals(a, StringComparison.InvariantCultureIgnoreCase));
    }
