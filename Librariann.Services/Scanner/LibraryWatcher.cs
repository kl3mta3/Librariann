...
public class LibraryWatcher : ILibraryWatcher
{
    ...
    public async Task StartWatching()
    {
        ...
        foreach (var libraryFolder in libraryFolders)
        {
            ...
            watcher.Disposed += (_, _) =>
                _logger.LogError("[LibraryWatcher] watcher was disposed when it shouldn't have been. Please report this to Librariann dev");
    ...
    private void OnError(object sender, ErrorEventArgs e)
    {
        ...
        {
            _logger.LogInformation("[LibraryWatcher] Too many restarts occured, you either have limited inotify or an OS constraint. Librariann will turn off folder watching to prevent high utilization of resources");
