    ...
    : IReaderService
{
    ...
    public async Task MarkChaptersAsRead(AppUser user, int seriesId, IList<Chapter> chapters)
    {
        ...
        if (series == null) throw new LibrariannException("series-doesnt-exist");
    ...
    private AppUserProgress? GetUserProgressForChapter(AppUser user, Chapter chapter)
    {
        ...
        if (user.Progresses == null)
        {
            ...
            throw new LibrariannException("progress-must-exist");
        }
    ...
    public async Task<bool> SaveReadingProgress(ProgressDto progressDto, int userId, bool saveToReadingSession = true)
    {
        ...
        try
        {
            ...
            if (userProgress == null && progressDto.PageNum == 0 && progressDto.PlaybackPositionSeconds is null or 0) return true;
            if (oldProgress == progressDto.PageNum && userProgress?.BookScrollId == progressDto.BookScrollId &&
                userProgress?.PlaybackPositionSeconds == progressDto.PlaybackPositionSeconds) return true;
            ...
            if (userProgress == null)
            {
                ...
                userProgress = new AppUserProgress
                {
                    ...
                    PlaybackPositionSeconds = progressDto.PlaybackPositionSeconds,
                };
            ...
            else
            {
                ...
                userProgress.PlaybackPositionSeconds = progressDto.PlaybackPositionSeconds;
    ...
    public async Task<HourEstimateRangeDto> GetEstimateToCompletionForChapter(int userId, int seriesId, int chapterId)
    {
        ...
        if (series == null || chapter == null)
            throw new LibrariannException(await localizationService.TranslateAsync(userId, "generic-error"));
