...
public class OAuthService(
    ...
    IEventHub eventHub,
    ILibrariannPlusAuditService librariannPlusAuditService): IOAuthService
{
    ...
    private async Task RefreshToken(ScrobbleProvider provider, AppUser user, CancellationToken ct)
    {
        ...
        var response = await librariannPlusApiService.RefreshToken(new RefreshTokenRequestDto()
        {
        ...
        if (!response.IsSuccess)
        {
            ...
            await librariannPlusAuditService.LogAsync(LibrariannPlusAuditCategory.System,
                LibrariannPlusEventType.SystemTokenRefresh, AuditStatus.Failure,
        ...
        await librariannPlusAuditService.LogAsync(LibrariannPlusAuditCategory.System,
            LibrariannPlusEventType.SystemTokenRefresh, AuditStatus.Success,
            payload: new AuditLogSystemTokenRefreshParamsDto
            {
                Provider = provider,
