...
using Librariann.Models.DTOs.Stats.V3.ClientDevice;
...
public class StatisticService(ILogger<StatisticService> logger, IDataContext context,
    IUnitOfWork unitOfWork, IEntityNamingService namingService, ILocalizationService localizationService
    ): IStatisticService
{
        ...
        CancellationToken ct = default)
    {
        var query = context.MangaFile
            ...
            .Select(MangaFileMapping.ToFileExtensionExportDtoExpression)
