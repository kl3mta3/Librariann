...
namespace Librariann.Services.Helpers;
...
public static partial class KoreaderHelper
{
    ...
    public static void UpdateProgressDto(ProgressDto progress, string koreaderPosition)
    {
        ...
        {
            // The format that Librariann accepts as a progress string. It tells Librariann where Koreader last left off.
    ...
    /// <summary>
    /// The format that Koreader accepts as a progress string. It tells Koreader where Librariann last left off.
    /// </summary>
    /// <remarks>
