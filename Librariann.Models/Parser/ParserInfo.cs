...
namespace Librariann.Models.Parser;
#nullable enable
...
public class ParserInfo
{
    ...
    /// <summary>
    /// Has an explicit "End" marker like (완결) which tells Librariann to use that as the Count, assuming no Count defined in ComicInfo.
    /// </summary>
