...
public class Series : IEntityDate, IHasReadTimeEstimate, IHasCoverImage, IHasMetadataIds
{
    ...
    /// <summary>
    /// Used internally for name matching. <see cref="Librariann.Services.Tasks.Scanner.Parser.Parser.Normalize"/>
    /// </summary>
    public required string NormalizedName { get; set; }
    /// <summary>
    /// Used internally for localized name matching. <see cref="Librariann.Services.Tasks.Scanner.Parser.Parser.Normalize"/>
    /// </summary>
    ...
    /// </summary>
    /// <remarks>The file is managed internally to Librariann's APPDIR</remarks>
    ...
    /// <summary>
    /// Denotes if the <see cref="Name"/> has been overridden by the user. If so, Librariann+ will not
