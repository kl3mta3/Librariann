...
namespace Librariann.Models.Entities.Enums.Audit;

/// <summary>
/// Why a Librariann+ metadata fetch was triggered. Surfaced on MetadataFetched audit entries so
...
public enum MetadataFetchTrigger
{
    ...
    ManualMatch = 3,
    /// <summary>
    /// Fetched by the scheduled daily Librariann+ data refresh job.
    /// </summary>
