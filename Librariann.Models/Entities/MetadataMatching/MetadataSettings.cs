...
namespace Librariann.Models.Entities.MetadataMatching;

/// <summary>
/// Handles the metadata settings for Librariann+
/// </summary>
public class MetadataSettings
{
    ...
    /// <summary>
    /// Do not allow any Genre/Tag in this list to be written to Librariann
    /// </summary>
    public List<string> Blacklist { get; set; }

    /// <summary>
    /// Only allow these Tags to be written to Librariann
    /// </summary>
