...
/// <summary>
/// External Metadata from Librariann+ for a Series
/// </summary>
public class ExternalSeriesMetadata : IEntityDate
{
    ...
    /// <summary>
    /// External Reviews for the Series. Managed by Librariann for Librariann+ users
    /// </summary>
    ...
    /// <summary>
    /// External recommendations will include all recommendations and will have a seriesId if it's on this Librariann instance.
    /// </summary>
