...
public class AppUserReadingProfile
{
    ...
    /// <summary>
    /// Book Reader Option: User-selected background color for customizable reader themes
    /// </summary>
    public string BookReaderBackgroundColor { get; set; } = "#F1E4D5";
    /// <summary>
    /// Book Reader Option: Opacity percentage for customizable reader backgrounds
    /// </summary>
