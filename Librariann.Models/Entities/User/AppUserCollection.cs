...
public class AppUserCollection : IEntityDate, IHasCoverImage
{
    ...
    // Sync stuff for Librariann+
    /// <summary>
    /// Last time Librariann Synced the Collection with an upstream source (for non Librariann sourced collections)
    /// </summary>
    public DateTime LastSyncUtc { get; set; }
    /// <summary>
    /// Who created/manages the list. Non-Librariann lists are not editable by the user, except to promote
    /// </summary>
    public ScrobbleProvider Source { get; set; } = ScrobbleProvider.Librariann;
    /// <summary>
    /// For Non-Librariann sourced collections, the url to sync from
    /// </summary>
    public string? SourceUrl { get; set; }
    /// <summary>
    /// Total number of items as of the last sync. Not applicable for Librariann managed collections.
    /// </summary>
