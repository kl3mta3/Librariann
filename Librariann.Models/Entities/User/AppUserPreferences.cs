...
public class AppUserPreferences
{
    ...
    /// <summary>
    /// Book Reader Option: Maps to the default Librariann font-family (inherit) or an override
    /// </summary>
    ...
    /// <summary>
    /// UI Site Global Setting: The UI theme mode the user should use. Replaces the old downloadable/uploadable
    /// SiteTheme system (removed - see ThemeMode's doc comment).
    /// </summary>
    /// <remarks>Should default to Dark</remarks>
    ...
    /// <summary>
    /// UI Site Global Setting: Should Librariann prompt user to confirm downloads that are greater than 100 MB.
    /// </summary>
    public bool PromptForDownloadSize { get; set; } = true;
    /// <summary>
    /// UI Site Global Setting: Should Librariann disable CSS transitions
    /// </summary>
    ...
    /// <summary>
    /// UI Site Global Setting: Should Librariann render ColorScape gradients
    /// </summary>
    public bool ColorScapeEnabled { get; set; } = true;
    /// <summary>
    /// Enable data saver mode across Librariann, limiting information that is pre-fetched
    /// </summary>
    ...
    /// <summary>
    /// Genres the user does not want used for home shelves or discovery recommendations.
    /// This is a personalization preference, not an authorization boundary.
    /// </summary>
    public List<int> IgnoredGenreIds { get; set; } = [];

    /// <summary>
    /// Genres the user has explicitly favorited. New matching items can be promoted on their home page.
    /// </summary>
