...
public class AppUser : IdentityUser<int>, IHasConcurrencyToken, IHasCoverImage
{
    ...
    /// </summary>
    /// <remarks>Requires Librariann+ Subscription</remarks>
    ...
    /// <summary>
    /// The IdentityProvider for the user, default to <see cref="Enums.IdentityProvider.Librariann"/>
    /// </summary>
    public IdentityProvider IdentityProvider { get; set; } = IdentityProvider.Librariann;
    ...
    /// <summary>
    /// Auth keys for access to Librariann
    /// </summary>
