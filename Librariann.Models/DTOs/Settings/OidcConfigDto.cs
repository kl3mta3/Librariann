...
{
    /// <summary>
    /// Optional OpenID Connect Authority URL. Stored in the server settings and bootstrap configuration.
    /// </summary>
    public string Authority { get; set; } = string.Empty;
    /// <summary>
    /// Optional OpenID Connect ClientId, defaults to the application client id.
    /// </summary>
    public string ClientId { get; set; } = string.Empty;
    /// <summary>
    /// Optional OpenID Connect secret. Persisted only through protected credential storage.
    /// </summary>
    ...
    /// <summary>
    /// Overwrite Librariann roles, libraries and age rating with OpenIDConnect provided roles on log in.
    /// </summary>
    public bool SyncUserSettings { get; set; } = false;
    /// <summary>
    /// A prefix that all roles Librariann checks for during sync must have
    /// </summary>
    ...
    /// <summary>
    /// Custom scopes Librariann should request from your OIDC provider
    /// </summary>
