namespace Librariann.Models.DTOs.ReadingLists.CBL.RemapRules;
#nullable enable
...
public sealed record CreateRemapRuleDto
{
    ...
    /// <summary>
    /// Optional: Librariann Volume ID for issue-level rules
    /// </summary>
    public int? VolumeId { get; set; }
    /// <summary>
    /// Optional: Librariann Chapter ID for issue-level rules
    /// </summary>
