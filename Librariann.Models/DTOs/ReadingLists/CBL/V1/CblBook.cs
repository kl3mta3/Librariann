...
namespace Librariann.Models.DTOs.ReadingLists.CBL.V1;
...
public sealed record CblBook
{
    ...
    /// </summary>
    /// <remarks>This is not part of the standard and explicitly for Librariann to support non cbz/cbr files</remarks>
