...
{
    /// <summary>
    /// The Chapter is not present in Librariann
    /// </summary>
    [Description("Chapter missing")]
    ChapterMissing = 0,
    /// <summary>
    /// The Volume is not present in Librariann or no Volume field present in CBL and there is no chapter matching
    /// </summary>
    [Description("Volume missing")]
    VolumeMissing = 1,
    /// <summary>
    /// The Series is not present in Librariann or the user does not have access to the Series due to some account restrictions
    /// </summary>
    ...
    NameConflict = 3,
    /// <summary>
    /// Every Series in the Reading list is missing from within Librariann or user has access restrictions to
    /// </summary>
