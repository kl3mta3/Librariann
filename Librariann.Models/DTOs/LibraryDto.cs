...
using Librariann.Models.Attributes;
...
public sealed record LibraryDto : LiteLibraryDto
{
    ...
    /// <summary>
    /// Allow Librariann to read metadata (ComicInfo.xml, Epub, PDF)
    /// </summary>
    public bool EnableMetadata { get; set; } = true;
    /// <summary>
    /// Should Librariann remove sort articles "The" for the sort name
    /// </summary>
