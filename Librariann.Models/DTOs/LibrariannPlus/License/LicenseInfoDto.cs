...
public enum LibrariannPlusSubscriptionState
{
    Active = 0,
    /// <summary>Only present for Librariann v0.9.0.6.</summary>
    Cancelled = 1,
    Paused = 2,
...
public enum LibrariannPlusBillingInterval
{
    Day = 0,
    Week = 1,
    Month = 2,
...
public sealed record LicenseInfoDto
{
    ...
    /// </summary>
    [EnumDataType(typeof(LibrariannPlusSubscriptionState))]
    public LibrariannPlusSubscriptionState State { get; set; }
    ...
    /// <summary>
    /// Is the installed version valid for Librariann+ (aka within 3 releases)
    /// </summary>
    /// <remarks>This is used only on Librariann</remarks>
    ...
    /// <summary>
    /// A license is stored within Librariann
    /// </summary>
