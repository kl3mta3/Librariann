...
using Librariann.Database.Migrations;
using Librariann.Models.Entities.History;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Logging;
using ExternalSeriesMetadata = Librariann.Models.Entities.Metadata.ExternalSeriesMetadata;

namespace Librariann.Server.ManualMigrations.v0._8._5;

/// <summary>
/// v0.8.5 - Migrating Librariann+ BlacklistedSeries table to Series entity to streamline implementation and generate a "Needs Manual Match" entry for the Series
/// </summary>
