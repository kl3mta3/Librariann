...
namespace Librariann.Server.ManualMigrations.v0._8._8;

/// <summary>
/// v0.8.8 - If Librariann+ users had Metadata Matching settings already, ensure the new non-Librariann+ system is enabled to match
/// existing experience
/// </summary>
