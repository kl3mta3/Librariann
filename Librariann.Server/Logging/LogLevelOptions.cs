...
/// <summary>
/// This class represents information for configuring Logging in the Application. Only a high log level is exposed and Librariann
...
public static class LogLevelOptions
{
    ...
    public const string OutputTemplate = "[Librariann] [{Timestamp:yyyy-MM-dd HH:mm:ss.fff zzz} {CorrelationId} {ThreadId}] [{Level}] {SourceContext} {Message:lj}{NewLine}{Exception}";
    ...
    public static LoggerConfiguration CreateConfig(HostBuilderContext context, LoggerConfiguration configuration)
    {
        return configuration
            ...
            .MinimumLevel.Override("Librariann.Server.Middleware.AuthKeyAuthenticationHandler", LogEventLevel.Error)
