    ...
    : BaseApiController
{
    ...
    /// <summary>
    /// Syncs book progress with Librariann. Will attempt to save the underlying reader position if possible.
    /// </summary>
    ...
    /// <summary>
    /// Gets book progress from Librariann, if not found will return a 400
    /// </summary>
    /// <param name="apiKey"></param>
