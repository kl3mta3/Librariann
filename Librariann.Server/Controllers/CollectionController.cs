...
using Librariann.Models.DTOs.CollectionTags;
    ...
    IEventHub eventHub) : BaseApiController
{
    ...
    /// <summary>
    /// For the authenticated user, if they have an active Librariann+ subscription and a MAL username on record,
    ...
    /// <summary>
    /// Imports a MAL Stack into Librariann
    /// </summary>
    /// <param name="dto"></param>
    /// <returns></returns>
